...
# -----------------------------------------------------------------------------
# The bnembeddedfont module provides classes used to manage fonts
#
...
#
# - BNEmbeddedFont:
#       A font definition (managed by BNEmbeddedFonts collection)
#
# -----------------------------------------------------------------------------
...
class BNEmbeddedFonts(QObject):
    ...
    def remove(self, item):
        ...
        if removedEmbeddedFont is not None:
            try:
