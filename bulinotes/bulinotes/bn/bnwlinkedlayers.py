...
# -----------------------------------------------------------------------------
# The nbwlinkedlayers module provides widget used to manage liked layers list
#
# Main classes from this module
#
# - BNLinkedLayersModel:
#       Model to manage linked layers
#
# - BNWLinkedLayers
#       View to manage linked layers
#
# - BNLinkedLayerEditor
#       Editor for linked layers properties
# -----------------------------------------------------------------------------
